								...
								<>
									...
									>
										<List sx={{ width: 250 }}>
											...
											<ListItem className="text-center">Hi there 👋</ListItem>
											<ListItem>Enumerator {userData?.user?.user?.username}</ListItem>
											<Divider />
											...
											<ListItem disablePadding>
												...
												>
													<ListItemIcon>
														<RefreshIcon style={{ color: '#007922' }} />
													</ListItemIcon>
													<ListItemText
														primary={'Refresh'}
														sx={{ color: '#007922' }}
